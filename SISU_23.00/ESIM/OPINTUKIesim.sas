...
%LET MINIMI_OPINTUKI_VUOSI = 2023;
%LET MAKSIMI_OPINTUKI_VUOSI = 2023;
...
%LET MINIMI_OPINTUKI_AIKKOUL = 1; 
%LET MAKSIMI_OPINTUKI_AIKKOUL = 1; 
...
IF &VUOSIKA = 2 THEN DO;
	%AsumLisaKS(ASLIS, OPINTUKI_VUOSI, OPINTUKI_KUUK, INF, OPINTUKI_KORK, OPINTUKI_IKA, 0, OPINTUKI_ASKUST, OPINTUKI_OMA_TULO, OPINTUKI_VANH_TULO, OPINTUKI_VANH_TULO, OPINTUKI_PUOL_TULO);
END;
ELSE DO;
	%AsumLisaVS(ASLIS, OPINTUKI_VUOSI, INF, OPINTUKI_KORK, OPINTUKI_IKA, 0, OPINTUKI_ASKUST, OPINTUKI_OMA_TULO, OPINTUKI_VANH_TULO, OPINTUKI_VANH_TULO, OPINTUKI_PUOL_TULO);
END;
...
FORMAT OPINTUKI_VUOSI OPINTUKI_KUUK OPINTUKI_AIKKOUL OPINTUKI_KOTONA_AS OPINTUKI_KORK TUKIAIKA OPINTUKI_KK OPINTUKI_IKA 8.;
