...
311 Korotettu äitiys-/raskausraha
...
IF SUBSTRN(KOKO_TILANNE&suff, 1, 1) = 3 THEN DO;
	...
	/* 4.2.3 Korotettu vanhemnpainpäiväraha; äitiysraha 56 ensimmäiseltä päivältä / raskauspäiväraha 40 päivältä; 90 %:n kerroin */
 ...
 ************************************************************************************************************************************************************;
 * Ohjelma haarautuu kahteen osaan, joista ensimmäisessä otetaan käyttöön sotemuutokset (vuodesta 2023 eteenpäin) ja toisessa noudatetaan vanhaa lainsäädäntöä*; 
 ************************************************************************************************************************************************************;
...
PROC DATASETS LIB=OUTPUT NOPRINT;
	...
	ANS = 'Ansiotulovähennys (2023-), (e/v)'
	ANS_PUOL = 'Puoliso: Ansiotulovähennys(2023-), (e/v)'
