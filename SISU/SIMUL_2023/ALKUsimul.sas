...
%MACRO TeeGlobaalit;
	...
	%GLOBAL OUT POIMINTA TULOKSET 
			...
			INF MVUOSI AVUOSI LVUOSI LKUUK AINEISTO AINEISTO_KK KIVERO_AINEISTO TULOSNIMI_SV TULOSNIMI_KT TULOSNIMI_TT
			...
			ASUMKUST_MAKS VARALLISUUSDATA VARALLISUUSKATTO
