...
%IF &START NE 1 %THEN %DO;
	...
	* Inflaatiokorjaus. Euro- tai markkamääräisten parametrien haun yhteydessä suoritettavassa
	...
	%LET MUUTTUJAT = aemk ELAKASUMTUKI; 			/* Summataulukoissa taulukoitavat muuttujat */
...
%MACRO ElAsumTuki_Muut_Poiminta;
	...
	%IF &POIMINTA = 1 %THEN %DO;
		...
		DATA TEMP.TEMP_ELASUMTUKI_PERUS; 
			...
			eastukikr yastukikr elak paos svatva svatvp teinova tpeito toyjmyv tnoosvab tenosve tuosvv toyjmav varhp
		...
		PROC SQL;
			...
			AS SELECT a.hnro, a.knro, a.ELASUMTUKI_YKSIKKO, a.ONOIKEUSYKS, a.PONOIKEUSYKS, a.VONOIKEUSYKS,
				...
				c.puoliso, c.tperhel, c.leelake, c.tkansel, c.velake, c.tkelake, c.ikavu, c.aslaji, c.eastukikr, c.yastukikr, c.elak, c.paos,
	...
	%IF &START NE 1 %THEN %DO;
		...
		DATA TEMP.&TULOSNIMI_EA;
			...
			%IF &TULOSLAAJ = 1 %THEN %DO; 
				...
				(KEEP = hnro knro &PAINO aemk ikavu ikavuv desmod soss paasoss elivtu koulas koulasv rake maakunta)
				TEMP.&TULOSNIMI_EA;
			%END;
			...
			/* Annetaan simuloiduille muuttujille selitteet */
			LABEL 
			aemk = 'Eläkkeensaajan asumistuki, DATA';
