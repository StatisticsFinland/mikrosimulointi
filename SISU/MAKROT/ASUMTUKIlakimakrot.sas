...
/* Makron parametrit:
		...
		varallisuus: Varallisuuden m‰‰r‰ (euroa, vuoden lopussa)
*/

%MACRO As2015PeruskaavaS(tulos, mvuosi, mkuuk, minf, hyvasumismeno, perusomavastuu, varallisuus) /
DES = "ASUMTUKI: Asumistuen peruskaava";
	...
	ELSE IF &VarallKatto > 0 AND &varallisuus >= &VarallKatto THEN &tulos = 0;
...
%MACRO As2015PerusomavastuuS(tulos, mvuosi, mkuuk, minf, tulot, tyotulot, aikuistenlkm, lastenlkm, varallisuus, opinraha = 0) /
DES = "ASUMTUKI: Perusomavastuu";
	...
	IF &aikuistenlkm = 1 THEN varallisuushuom = MAX(0, &VarallPros * SUM(&varallisuus, -&VarallRaja1) / 12);
	ELSE varallisuushuom = MAX(0, &VarallPros * SUM(&varallisuus, -&VarallRaja2) / 12);

	eipyorastukitulot = SUM(yhttulot, varallisuushuom, -vahtyotulotsum);
	...
	eipyorperusomavastuu perusomavastuu varallisuushuom;
...
%MACRO As2015AsumistukiVuokraKS(tulos, mvuosi, mkuuk, minf, kuntaryhma, vammaistenlkm, vuokra, alivuokralaisenvuokra, erillinenvesi, erillinenlampo, lisakustannusryhma, tulot, tyotulot, aikuistenlkm, lastenlkm, varallisuus, opinraha = 0) /
DES = "ASUMTUKI: Asumistuki kuukaudessa vuokra-asunnossa";
	...
	%As2015PerusomavastuuS(perusomavastuu, &mvuosi, &mkuuk, &minf, &tulot, &tyotulot, &aikuistenlkm, &lastenlkm, &varallisuus, opinraha = &opinraha);

	%As2015PeruskaavaS(asumistuki, &mvuosi, &mkuuk, &minf, hyvasumismeno, perusomavastuu, &varallisuus);
...
%MACRO As2015AsumistukiVuokraVS(tulos, mvuosi, minf, kuntaryhma, vammaistenlkm, vuokra, alivuokralaisenvuokra, erillinenvesi, erillinenlampo, lisakustannusryhma, tulot, tyotulot, aikuistenlkm, lastenlkm, varallisuus, opinraha = 0) /
DES = "ASUMTUKI: Asumistuki vuosikeskiarvona vuokra-asunnossa";

	asvuosi = 0;

	%DO kuuk=1 %TO 12;
		%As2015AsumistukiVuokraKS(askk, &mvuosi, &kuuk, &minf, &kuntaryhma, &vammaistenlkm, &vuokra, &alivuokralaisenvuokra, &erillinenvesi, &erillinenlampo, &lisakustannusryhma, &tulot, &tyotulot, &aikuistenlkm, &lastenlkm, &varallisuus, opinraha = &opinraha);
...
%MACRO As2015AsumistukiOmaOsakeKS(tulos, mvuosi, mkuuk, minf, kuntaryhma, vammaistenlkm, vastike, alivuokralaisenvuokra, erillinenvesi, erillinenlampo, lisakustannusryhma, korko, tulot, tyotulot, aikuistenlkm, lastenlkm, varallisuus, opinraha = 0) /
...
%MACRO As2015AsumistukiOmaOsakeVS(tulos, mvuosi, minf, kuntaryhma, vammaistenlkm, vastike, alivuokralaisenvuokra, erillinenvesi, erillinenlampo, lisakustannusryhma, korko, tulot, tyotulot, aikuistenlkm, lastenlkm, varallisuus, opinraha = 0) /
DES = "ASUMTUKI: Asumistuki vuosikeskiarvona omassa osakeasunnossa";

	asvuosi = 0;

	%DO kuuk=1 %TO 12;
		%As2015AsumistukiOmaOsakeKS(askk, &mvuosi, &kuuk, &minf, &kuntaryhma, &vammaistenlkm, &vastike, &alivuokralaisenvuokra, &erillinenvesi, &erillinenlampo, &lisakustannusryhma, &korko, &tulot, &tyotulot, &aikuistenlkm, &lastenlkm, &varallisuus, opinraha = &opinraha);
		asvuosi = SUM(asvuosi, askk); 
	%END;
...
%MACRO As2015AsumistukiOmaTaloKS(tulos, mvuosi, mkuuk, minf, kuntaryhma, vammaistenlkm, alivuokralaisenvuokra, lisakustannusryhma, korko, tulot, tyotulot, aikuistenlkm, lastenlkm, varallisuus, opinraha = 0) /
...
%MACRO As2015AsumistukiOmaTaloVS(tulos, mvuosi, minf, kuntaryhma, vammaistenlkm, alivuokralaisenvuokra, lisakustannusryhma, korko, tulot, tyotulot, aikuistenlkm, lastenlkm, varallisuus, opinraha = 0) /
DES = "ASUMTUKI: Asumistuki vuosikeskiarvona omassa omakotitalossa";

	asvuosi = 0;

	%DO kuuk=1 %TO 12;
		%As2015AsumistukiOmaTaloKS(askk, &mvuosi, &kuuk, &minf, &kuntaryhma, &vammaistenlkm, &alivuokralaisenvuokra, &lisakustannusryhma, &korko, &tulot, &tyotulot, &aikuistenlkm, &lastenlkm, &varallisuus, opinraha = &opinraha);
		asvuosi = SUM(asvuosi, askk); 
	%END;
