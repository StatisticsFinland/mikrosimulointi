...
Seuraava ryhmittely on voimassa vuosina 2024-:
...
ELSE DO;
	...
	%IF &VUOSIKA = 2 %THEN %DO;
		IF ASUMTUKI_ASTYYPPI IN (1,3) THEN DO;
			%As2015AsumistukiVuokraKS(ASUMTUKI_MAARAK, ASUMTUKI_VUOSI, ASUMTUKI_KUUK, INF, ASUMTUKI_KRYHMA, ASUMTUKI_VAMMLKM, ASUMTUKI_VUOKRA, ASUMTUKI_ALIVUOKRA, ASUMTUKI_EVESI, ASUMTUKI_ELAMM, ASUMTUKI_LKRYHMA, ASUMTUKI_TULOT, ASUMTUKI_TYOTULOT, ASUMTUKI_AIKUISIA, ASUMTUKI_LAPSIA, ASUMTUKI_OMAISUUS);
		END;
		ELSE IF ASUMTUKI_ASTYYPPI = 2 AND ASUMTUKI_OMAKOTI = 0 THEN DO;
			%As2015AsumistukiOmaOsakeKS(ASUMTUKI_MAARAK, ASUMTUKI_VUOSI, ASUMTUKI_KUUK, INF, ASUMTUKI_KRYHMA, ASUMTUKI_VAMMLKM, ASUMTUKI_VUOKRA, ASUMTUKI_ALIVUOKRA, ASUMTUKI_EVESI, ASUMTUKI_ELAMM, ASUMTUKI_LKRYHMA, ASUMTUKI_ASKOROT, ASUMTUKI_TULOT, ASUMTUKI_TYOTULOT, ASUMTUKI_AIKUISIA, ASUMTUKI_LAPSIA, ASUMTUKI_OMAISUUS);
		END;
		ELSE DO;
			%As2015AsumistukiOmaTaloKS(ASUMTUKI_MAARAK, ASUMTUKI_VUOSI, ASUMTUKI_KUUK, INF, ASUMTUKI_KRYHMA, ASUMTUKI_VAMMLKM, ASUMTUKI_ALIVUOKRA, ASUMTUKI_LKRYHMA, ASUMTUKI_ASKOROT, ASUMTUKI_TULOT, ASUMTUKI_TYOTULOT, ASUMTUKI_AIKUISIA, ASUMTUKI_LAPSIA, ASUMTUKI_OMAISUUS);
		END;
	%END;
	%ELSE %DO;
		IF ASUMTUKI_ASTYYPPI IN (1,3) THEN DO;
			%As2015AsumistukiVuokraVS(ASUMTUKI_MAARAK, ASUMTUKI_VUOSI, INF, ASUMTUKI_KRYHMA, ASUMTUKI_VAMMLKM, ASUMTUKI_VUOKRA, ASUMTUKI_ALIVUOKRA, ASUMTUKI_EVESI, ASUMTUKI_ELAMM, ASUMTUKI_LKRYHMA, ASUMTUKI_TULOT, ASUMTUKI_TYOTULOT, ASUMTUKI_AIKUISIA, ASUMTUKI_LAPSIA, ASUMTUKI_OMAISUUS);
		END;
		ELSE IF ASUMTUKI_ASTYYPPI = 2 AND ASUMTUKI_OMAKOTI = 0 THEN DO;
			%As2015AsumistukiOmaOsakeVS(ASUMTUKI_MAARAK, ASUMTUKI_VUOSI, INF, ASUMTUKI_KRYHMA, ASUMTUKI_VAMMLKM, ASUMTUKI_VUOKRA, ASUMTUKI_ALIVUOKRA, ASUMTUKI_EVESI, ASUMTUKI_ELAMM, ASUMTUKI_LKRYHMA, ASUMTUKI_ASKOROT, ASUMTUKI_TULOT, ASUMTUKI_TYOTULOT, ASUMTUKI_AIKUISIA, ASUMTUKI_LAPSIA, ASUMTUKI_OMAISUUS);
		END;
		ELSE DO;
			%As2015AsumistukiOmaTaloVS(ASUMTUKI_MAARAK, ASUMTUKI_VUOSI, INF, ASUMTUKI_KRYHMA, ASUMTUKI_VAMMLKM, ASUMTUKI_ALIVUOKRA, ASUMTUKI_LKRYHMA, ASUMTUKI_ASKOROT, ASUMTUKI_TULOT, ASUMTUKI_TYOTULOT, ASUMTUKI_AIKUISIA, ASUMTUKI_LAPSIA, ASUMTUKI_OMAISUUS);
		END;
	%END;
