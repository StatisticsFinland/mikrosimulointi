...
%LET MINIMI_VERO_VUOSI = 2021;
%LET MAKSIMI_VERO_VUOSI = 2021;
...
IF VERO_PTULO > 0 THEN DO;
	%TuloVerot_SimpleS(TULOVERO, VERO_VUOSI, INF, VERO_PTULO);
...
IF VERO_NETTOPALKKA > 0 THEN DO;
	%BruttotuloS(BRUTTOTULO, VERO_VUOSI, INF, VERO_NETTOPALKKA);
...
IF VERO_PTULO > 0 THEN DO;
	%TuloVerot_SimpleMargS(MARGINAALIVERO, VERO_VUOSI, INF, VERO_PTULO, VERO_ASKEL);
...
PERVAH = 'Kunnallisverotuksen perusvähennys, (e)'
...
PPERVAH = 'Puoliso: Kunnallisverotuksen perusvähennys, (e)'
