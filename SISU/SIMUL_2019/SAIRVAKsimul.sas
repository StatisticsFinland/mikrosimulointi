/*******************************************************************
*  Kuvaus: Sairausvakuutuksen päivärahojen simuloimalli 2019       * 
...
IF &SDATATULO NE 1 OR tuloprt = 0 THEN DO;
	...
	%VanhPRahaVS(PROS90VANH, &LVUOSI, &INF, 1, 0, 0, 0, VANH_TULO);
	%VanhPRahaVS(PROS75VANH, &LVUOSI, &INF, 0, 1, 0, 0, VANH_TULO);
	%VanhPRahaVS(NORMVANH, &LVUOSI, &INF, 0, 0, 1, 0, VANH_TULO);
	/* Työnantajalle maksetut */
	%VanhPRahaVS(PROS90VANH_TYONANT, &LVUOSI, &INF, 1, 0, 0, 0, VANHTULO_TYONANT);
	%VanhPRahaVS(PROS75VANH_TYONANT, &LVUOSI, &INF, 0, 1, 0, 0, VANHTULO_TYONANT);
...
PROS75VANH = aivpv1 * PROS75VANH;
NORMVANH = aivpv2 * NORMVANH;
PROS90VANH_TYONANT = aivpvkt * PROS90VANH_TYONANT;
PROS75VANH_TYONANT = aivpvt1 * PROS75VANH_TYONANT;
...
VANHPR = SUM(NORMVANH, PROS90VANH, PROS75VANH);
...
VANHPR_TYONANT = SUM(NORMVANH_TYONANT, PROS75VANH_TYONANT, PROS90VANH_TYONANT);
...
ARRAY PISTE 
	...
	PROS90VANH PROS75VANH NORMVANH PROS90VANH_TYONANT NORMVANH_TYONANT;
DO OVER PISTE;
...
PROS90VANH_TYONANT = 'Työnantajille maksetut korotetut vanhempainpäivärahat (90% korvausaste), MALLI'
PROS75VANH_TYONANT = 'Työnantajille maksetut korotetut vanhempainpäivärahat (75% korvausaste), MALLI'
