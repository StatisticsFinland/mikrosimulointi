...
/* 2.1 Poimitaan tarvittavat palveluaineiston muuttujat taulukkoon STARTDAT.START_TOIMTUKI */
		...
		DATA STARTDAT.START_TOIMTUKI;
			...
			llmk kokorve lapsikorotus rielake ryelake amstipe lbeltuki hsotav hasepr elasa rahsa
			...
			hoimakso hoiaikay hoimaksy hopila opirake opirako tukiaika optukk tpjta aemk hoiaikap hoimaksp
			varm lveru anstukor yrtukor vvvmk1 vvvmk3 vvvmk5 dtyhtep korosapkw
			tmtukimk korosatkg tmaat1evyr tmaat1pevyr tliik1evyr tliikpevyr tporo1evyr
			tyhtmatevyr tyhtateevyr tyhtmat	tyhtate yrvahan yrvahpo kuntakoodi jasenia AILMKORQDAT ttyosuhdematkal tpolkupyoraetuv);
		RUN;
		...
		DATA STARTDAT.START_TOIMTUKI;
			...
			* Toimeentulotukeen vaikuttavat muut verovapaat tulot;
			VEROTTUL_MUU = SUM(kokorve, -lahdever, amstipe, apuraha, hlakav,	
					...
					hasepr, ulkelve, ulkelmuu, ttyosuhdematkal, tpolkupyoraetuv);
