...
%MACRO Kansanelake_SimpleKS(tulos, mvuosi, mkuuk, minf, laitos, puoliso, kryhma, tyoelake, asusuht,
...
%MACRO Kansanelake_SimpleVS(tulos, mvuosi, minf, laitos, puoliso, kryhma, tyoelake, asusuht,
ontyokyvyte = 0, tyotulo = 0) 
/ DES = "KANSEL: Kansanel‰ke kuukausitasolla vuosikeskiarvona";
	...
	%DO i = 1 %TO 12;
		%Kansanelake_SimpleKS(temp, &mvuosi, &i, &minf, &laitos, &puoliso, &kryhma, &tyoelake, &asusuht, ontyokyvyte = &ontyokyvyte, tyotulo = &tyotulo);
...
%MACRO TakuuElakeKS(tulos, mvuosi, mkuuk, minf, kokonelake, varhkerr,
ontyokyvyte = 0, tyotulo = 0)
...
%MACRO TakuuElakeVS(tulos, mvuosi, minf, kokonelake, varhkerr,
ontyokyvyte = 0, tyotulo = 0)
/ DES = "KANSEL: Takuuel‰ke kuukausitasolla vuosikeskiarvona";
	...
	%DO i = 1 %TO 12;
		%TakuuElakeKS(temp, &mvuosi, &i, &minf, &kokonelake, &varhkerr, ontyokyvyte = &ontyokyvyte, tyotulo = &tyotulo);
