...
%LET MINIMI_VERO_VUOSI = 2022;
%LET MAKSIMI_VERO_VUOSI = 2023;
...
%LET MINIMI_VERO_KUNNPROS = 18.00; 
%LET MAKSIMI_VERO_KUNNPROS = 18.00;
...
KOKONTULO = (VERO_PTULO + VERO_MERITULO + VERO_PRAHATULO + VERO_MTULO + VERO_ETULO + VERO_OPRAHA + VERO_OSANSTULO + VERO_MUUANSTULO + VERO_OSINKOTULO + VERO_VUOKRATULO + VERO_KORKOTULO + VERO_MUUPOTULO);

* Ansiotulot (ilman yhtiöveron hyvitystä);

ANSIOTULO = (VERO_PTULO + VERO_MERITULO + VERO_PRAHATULO + VERO_MTULO + VERO_ETULO + VERO_OPRAHA + VERO_OSANSTULO + VERO_MUUANSTULO);
...
PUHDANSTULO = ANSIOTULO - SUM(TULHANKSUMS, TULHANKSUMSM, ASUNTOVAH);
...
IF VERO_VUOSI >= 2023 THEN DO; 
	...
	* Vähennykset ;
	...
	%ElTulVahS(ELVAH, VERO_VUOSI, INF, VERO_ETULO, PUHDANSTULO);

	%VerMeriVahS(MERIVAH, VERO_VUOSI, INF, VERO_MERITULO); 

	%OpRahVahS(OPRAHVAH, VERO_VUOSI, INF, VERO_OPRAHA, PUHDANSTULO);

	%AnsVahS(ANS, VERO_VUOSI, INF, PUHDANSTULO, (VERO_PTULO + VERO_MERITULO + VERO_MTULO));

	/* Ei oteta huomioon merityötulojen työeläkemaksuja, koska MEL -maksuprosentit poikkeavat TYEl:stä */
	%TyoelMaksuS(TYOELMAKSU, VERO_VUOSI, INF, VERO_IKA, VERO_PTULO);

	%TyotMaksuS(TYOTMAKSU, VERO_VUOSI, INF, VERO_IKA, VERO_PTULO);

	%SvPrahaMaksuS(SPM, VERO_VUOSI, INF, VERO_IKA, (VERO_PTULO + VERO_MERITULO));
	...
	* Verotettava tulo ennen perusvähennystä;
	...
	VEROTULOP = MAX(PUHDANSTULO - TYOELMAKSU - TYOTMAKSU - SPMAKSU - ANS - MERIVAH - ELVAH - OPRAHVAH - VERO_MUUVAH, 0);	
...
*/
	* Vähennyksiä veroista;
	...
	%ValtVerTyotVahS_2023(VALTANSVAH, VERO_VUOSI, INF, (VERO_PTULO + VERO_MERITULO + VERO_MTULO + VERO_OSANSTULO), PUHDANSTULO, VERO_IKA);

	%ValtVerElVelvVahS(VELVVAHV, VERO_VUOSI, INF, VERO_EVLAPSIA, VERO_ELMAKSUT);

	%AlijHyvS(ALIJHYV, VERO_VUOSI, INF, VERO_PUOLISO, VERO_LAPSIA, (POTULO + YHTHYVPO), VERO_POVAHENN, VERO_ASKOROT, VERO_ENSASKOROT, VERO_KULKOROT, VERO_PUOLALIJ);

	%AlijHyvEritS(ALIJHYVERIT, VERO_VUOSI, INF, (POTULO + YHTHYVPO), VERO_POVAHENN, VERO_ASKOROT, VERO_ENSASKOROT, VERO_ELVAKMAKSU);

	%KotiTalVahS(KOTIVAH, VERO_VUOSI, INF, VERO_KOTITMENO);

	* Yhtiöveron hyvitys;
	* Muuttujat jätetty ohjelmaan teknisinä. Nollia vuodesta 2005 alkaen;
	...
	*VALTVEROTULO = MAX(TEMPA + TEMPB + YHTHYVANS - SUM(TULHANKSUMS, TULHANKSUMSM) - MERIVAHVAL - TYOELMAKSU - TYOTMAKSU - SPMAKSU - ELVAHV - VALTTVAH - VERO_MUUVAHVALT,0); 

	TEMPC = 0;

	VEROPOTULO = MAX(POTULO + YHTHYVPO - VERO_ASKOROT, VERO_ENSASKOROT - VERO_POVAHENN - TEMPC, 0); 

	YHTVALTVEROTULO = VEROTULO + VEROPOTULO;

	* Tuloverot ennen ansiotulovähennystä;

	%ValtTuloVeroS(VALTTULOVERO, VERO_VUOSI, INF, VEROTULO);

	%ElakeLisaVeroS(ELAKELISAVERO, VERO_VUOSI, INF, VERO_ETULO, ELVAH);

	VALTTULOVERO = SUM(VALTTULOVERO, ELAKELISAVERO);

	%KunnVeroS(KUNNVERO, VERO_VUOSI, INF, VERO_KESKIM, VERO_KUNNPROS, VEROTULO);

	%SairVakMaksuS(SVMAKSU, VERO_VUOSI, INF, VEROTULO, VERO_ETULO, (VERO_PTULO + VERO_MERITULO + VERO_MTULO));

	%KansElVakMaksuS(KEVMAKSU, VERO_VUOSI, INF, VEROTULO, VERO_ETULO);

	IF VERO_KIRKOSSA = 1 THEN DO;
		%KirkVeroS(KIRKVEROS, VERO_VUOSI, INF, VERO_KESKIM, VERO_KIRKPROS, VEROTULO);
	END;
	ELSE KIRKVEROS = 0;

	%POTulonVeroEritS(POTULOVERO, VERO_VUOSI, INF, VERO_OSINKOTULO, (VERO_VUOKRATULO + VERO_KORKOTULO + VERO_MUUPOTULO), (VERO_POVAHENN + VERO_ASKOROT + VERO_ENSASKOROT), VERO_KULKOROT, VERO_ELVAKMAKSU);


	* Tuloverot valtionverotuksen ansio/työtulovähennyksen jälkeen (jaetaan eri verolajeille, jos vuosi > 2008);

	%VahennJakoS(VALTTULOANSVERO, VERO_VUOSI, VALTANSVAH, 1, VALTTULOVERO, KUNNVERO, SVMAKSU, KEVMAKSU, KIRKVEROS, 0);
	%VahennJakoS(KUNNALLISVERO, VERO_VUOSI, VALTANSVAH, 2, VALTTULOVERO, KUNNVERO, SVMAKSU, KEVMAKSU, KIRKVEROS, 0);
	%VahennJakoS(SAIRAUSVAKUUTUSMAKSU, VERO_VUOSI, VALTANSVAH, 3, VALTTULOVERO, KUNNVERO, SVMAKSU, KEVMAKSU, KIRKVEROS, 0);
	%VahennJakoS(KELAVAKUUTUSMAKSU, VERO_VUOSI, VALTANSVAH, 4, VALTTULOVERO, KUNNVERO, SVMAKSU, KEVMAKSU, KIRKVEROS, 0);
	%VahennJakoS(KIRKOLLISVERO, VERO_VUOSI, VALTANSVAH, 5, VALTTULOVERO, KUNNVERO, SVMAKSU, KEVMAKSU, KIRKVEROS, 0);
	...
	* Valtion tulovero invalidi- ja ansiotulovähennyksen jälkeen;
	...
	VALTTULOINV = MAX(VALTTULOANSVERO2 - VELVVAHV,0);

	* Sijoitetaan verotettava tulo VALTVEROTULO-muuttujaan laskennallisista syistä;
...
* Vähennykset vain valtionverotuksessa;
	...
	%ValtElTulVahS(ELVAHV, VERO_VUOSI, INF, VERO_ETULO, PUHDANSTULO, KOKONTULO);

	%ValtTyoTuloVahS(VALTTVAH, VERO_VUOSI, INF, ANSIOTULO, SUM(VERO_PTULO, VERO_MERITULO));

	%ValtVerMeriVahS(MERIVAHVAL, VERO_VUOSI, INF, VERO_MERITULO); 

	* Vähennykset vain kunnallisverotuksessa;

	MUUANS2 = MAX(ANSIOTULO - VERO_ETULO,0);

	%KunnAnsVahS(KUNNANS, VERO_VUOSI, INF, PUHDANSTULO, MUUANS2, (VERO_PTULO + VERO_MERITULO + VERO_MTULO), (VERO_PTULO + VERO_MERITULO), KOKONTULO);

	%KunnElTulVahS(ELVELVAHK, VERO_VUOSI, INF, VERO_PUOLISO, 0, VERO_ETULO, PUHDANSTULO, KOKONTULO);

	%KunnVerMeriVahS(MERIVAHKUN, VERO_VUOSI, INF, VERO_MERITULO);

	%KunnOpRahVahS(OPRAHVAHK, VERO_VUOSI, INF, VERO_OPISK, VERO_OPRAHA, ANSIOTULO, PUHDANSTULO);
	...
	* Verotettava tulo kunnallisverotuksessa ennen perusvähennystä;
	...
	IF VERO_VUOSI < 1993 THEN PA = (KOKONTULO + YHTHYVPO - SUM(TULHANKSUMS, TULHANKSUMSM) - VERO_POVAHENN);
	ELSE PA = PUHDANSTULO;

	%KunnVerInvVahS(INVVAH_K, VERO_VUOSI, INF, VERO_INVOIKEUS82, VERO_INVPROS, PA, VERO_ETULO);

	KUNNVEROTULO = MAX(PA - TYOELMAKSU - TYOTMAKSU - SPMAKSU - KUNNANS - MERIVAHKUN - ELVELVAHK - OPRAHVAHK - VERO_MUUVAHKUNN -INVVAH_K,0);

	IF KUNNVEROTULO < 0 THEN KUNNVEROTULO = 0;

	%KunnPerVahS(PERVAH, VERO_VUOSI, INF, KUNNVEROTULO);
	...
	* Vähennyksiä veroista;
	...
	%ValtVerAnsVahS(VALTANSVAH, VERO_VUOSI, INF, (VERO_PTULO + VERO_MERITULO + VERO_MTULO + VERO_OSANSTULO), PUHDANSTULO);
	...
	* Tuloverot ennen ansiotulovähennystä;
	...
	%ValtTuloVeroS(VALTTULOVERO, VERO_VUOSI, INF, VALTVEROTULO);
	...
	%SairVakMaksuS(SVMAKSU, VERO_VUOSI, INF, KUNNVERTULOSP, VERO_ETULO, (VERO_PTULO + VERO_MERITULO + VERO_MTULO));
	...
	* Tuloverot lapsivähennyksen jälkeen;
	...
	* Valtion tulovero invalidi- ja ansiotulovähennyksen jälkeen;
	...
	VALTTULOINV = MAX(VALTTULOANSVERO2 - INVVAH - VELVVAHV,0);
END;
*************************************************************************************************************************************************************;
...
ANSTULVEROT = VALTTULOANSVERO5 + KUNNALLISVERO5 + SAIRAUSVAKUUTUSMAKSU5 + KELAVAKUUTUSMAKSU5 + KIRKOLLISVERO5;
...
%ValtVero_FinalS(VVKAT, VERO_VUOSI, YHTVALTVEROTULO, VALTTULOVERO, PAAOMAVERO3, (KUNNALLISVERO5 + SAIRAUSVAKUUTUSMAKSU5 + KELAVAKUUTUSMAKSU5 + KIRKOLLISVERO5));
...
KAIKKIVEROT1 = KUNNALLISVERO5 + SAIRAUSVAKUUTUSMAKSU5 + KELAVAKUUTUSMAKSU5 + KIRKOLLISVERO5 + (VAVERO + VALTTULVERKAT);

IF VALTTULOVERO < VALTANSVAH THEN TEMPD = VALTANSVAH - VALTTULOVERO;
ELSE TEMPD = 0;

IF VERO_VUOSI < 2009 THEN TEMPE = MIN(TEMPD, KUNNALLISVERO5 + SAIRAUSVAKUUTUSMAKSU5 + KELAVAKUUTUSMAKSU5 + KIRKOLLISVERO5);
ELSE TEMPE = 0; 

KAIKKIVEROT2 = KUNNALLISVERO5 + SAIRAUSVAKUUTUSMAKSU5 + KELAVAKUUTUSMAKSU5 + KIRKOLLISVERO5 + (VALTTULOANSVERO5 + PAAOMAVERO3) - YHTHYVYHT - TEMPE;
...
%ValtTuloVeroS(TEMPF, VERO_VUOSI, INF, VALTVEROTULO);
...
%YhtHyvJakoS(VALTIO1, 1, YHTHYVANS, YHTHYVPO, (VALTTULOANSVERO3 + PAAOMAVERO3), VALTTULOANSVERO5, KUNNALLISVERO5, SVMAKSU, 0, KIRKOLLISVERO5);
VALTIO=MAX(SUM(VALTIO1,-TEMPH),0);

%YhtHyvJakoS(KUNNAT, 2, YHTHYVANS, YHTHYVPO, (VALTTULOANSVERO3 + PAAOMAVERO3), VALTTULOANSVERO5, KUNNALLISVERO5, SVMAKSU, 0, KIRKOLLISVERO5);

%YhtHyvJakoS(KELA1, 3, YHTHYVANS, YHTHYVPO, (VALTTULOANSVERO3 + PAAOMAVERO3), VALTTULOANSVERO5, KUNNALLISVERO5, SVMAKSU, 0, KIRKOLLISVERO5);
KELA = SAIRAUSVAKUUTUSMAKSU5 + KELAVAKUUTUSMAKSU5 + SPMAKSU;

%YhtHyvJakoS(KIRKKO, 5, YHTHYVANS, YHTHYVPO, (VALTTULOANSVERO3 + PAAOMAVERO3), VALTTULOANSVERO5, KUNNALLISVERO5, SVMAKSU, 0, KIRKOLLISVERO5);
...
%IF &MAKSIMI_VERO_PUOLISO = 1 %THEN %DO;
	...
	* Kokonaistulot;
	...
	PKOKONTULO = (VERO_PPTULO + VERO_PMERITULO + VERO_PPRAHATULO + VERO_PMTULO + VERO_PETULO + VERO_POPRAHA + VERO_POSANSTULO + VERO_PMUUANSTULO + VERO_POSINKOTULO + VERO_PVUOKRATULO + VERO_PKORKOTULO + VERO_PMUUPOTULO);

	* Ansiotulot (ilman yhtiöveron hyvitystä);

	PANSIOTULO = (VERO_PPTULO + VERO_PMERITULO + VERO_PPRAHATULO + VERO_PMTULO + VERO_PETULO + VERO_POPRAHA + VERO_POSANSTULO + VERO_PMUUANSTULO);
	...
	* Pääomatulot (ilman yhtiöveron hyvitystä);
	...
	PPUHDASANSTULO = PANSIOTULO - SUM(PTULHANKSUMS, PTULHANKSUMSM, PASUNTOVAH);

	IF PPUHDASANSTULO < 0 THEN PPUHDASANSTULO = 0;
 ************************************************************************************************************************************************************;
 * Myös puolisokäsittelyn osalta ohjelma haarautuu kahteen osaan, joista ensimmäisessä otetaan käyttöön sotemuutokset (vuodesta 2023 eteenpäin) ja toisessa noudatetaan vanhaa lainsäädäntöä*; 
 ************************************************************************************************************************************************************;
 IF VERO_VUOSI >= 2023 THEN DO; 
	******************************************************************;
	* Tässä otetaan huomioon sote-uudistuksen aiheuttamat muutokset  *;
	...
	* Vähennykset;
	...
	%ElTulVahS(PELVAH, VERO_VUOSI, INF, VERO_PETULO, PPUHDASANSTULO);

	%MeriVahS(PMERIVAH, VERO_VUOSI, INF, VERO_PMERITULO); 

	%OpRahVahS(POPRAHVAH, VERO_VUOSI, INF, VERO_POPRAHA, PPUHDASANSTULO);

	%AnsVahS(PANS, VERO_VUOSI, INF, PPUHDASANSTULO, (VERO_PPTULO + VERO_PMERITULO + VERO_PMTULO));
	...
	%SvPrahaMaksuS(PSPM, VERO_VUOSI, INF, VERO_PIKA, (VERO_PPTULO + VERO_PMERITULO));
	...
	* Verotettava tulo ennen perusvähennystä;
	...
	PVEROTULOP = MAX(PPUHDANSTULO - PTYOELMAKSU - PTYOTMAKSU - PSPMAKSU - PANS - PMERIVAH - PELVAH - POPRAHVAH - PVERO_MUUVAH, 0);	
	...
	* Vähennyksiä veroista;
	...
	%ValtVerTyotVahS_2023(PVALTANSVAH, VERO_VUOSI, INF,  (VERO_PPTULO + VERO_PMERITULO + VERO_PMTULO + VERO_POSANSTULO), PPUHDASANSTULO, VERO_PIKA);

	%ValtVerElVelvVahS(PVELVVAHV, VERO_VUOSI, INF, VERO_PEVLAPSIA, VERO_PELMAKSUT);

	%AlijHyvS(PALIJHYV, VERO_VUOSI, INF, 1, VERO_LAPSIA, (PPOTULO + PYHTHYVPO), VERO_PPOVAHENN, 0, 0, 0, VERO_PPUOLALIJ);

	%AlijHyvEritS(PALIJHYVERIT, VERO_VUOSI, INF, (PPOTULO + PYHTHYVPO), VERO_PPOVAHENN, 0, 0, VERO_ELVAKMAKSU);
 ...
 /*
	PVALTVEROTULO = MAX(PTEMPA + PTEMPB + PYHTHYVANS - PTULHANKSUMS - PTULHANKSUMSM - PMERIVAHVAL - PTYOELMAKSU - PTYOTMAKSU - PSPMAKSU - PELVAHV - PVALTTVAH - VERO_PMUUVAHVALT,0);
*/
	...
	PYHTVALTVEROTULO = PVEROTULO + PVEROPOTULO;

	* Tuloverot ennen ansiotulovähennystä;

	%ValtTuloVeroS(PVALTTULOVERO, VERO_VUOSI, INF, PVEROTULO);

	%ElakeLisaVeroS(PELAKELISAVERO, VERO_VUOSI, INF, VERO_PETULO, PELVAH);

	PVALTTULOVERO = SUM(PVALTTULOVERO, PELAKELISAVERO);

	%KunnVeroS(PKUNNVERO, VERO_VUOSI, INF, VERO_PKESKIM, VERO_PKUNNPROS, PVEROTULO);

	%SairVakMaksuS(PSVMAKSU, VERO_VUOSI, INF, PVEROTULO, VERO_PETULO, (VERO_PPTULO + VERO_PMERITULO + VERO_PMTULO));

	%KansElVakMaksuS(PKEVMAKSU, VERO_VUOSI, INF, PVEROTULO, VERO_PETULO);
	...
	%POTulonVeroEritS(PPOTULOVERO, VERO_VUOSI, INF, VERO_POSINKOTULO, (VERO_PVUOKRATULO + VERO_PKORKOTULO + VERO_PMUUPOTULO), (VERO_PPOVAHENN + VERO_PASKOROT + VERO_PENSASKOROT), VERO_PKULKOROT, VERO_PELVAKMAKSU);

	* Tuloverot valtionverotuksen ansio/työtulovähennyksen jälkeen (jaetaan eri verolajeille, jos vuosi > 2008);

	IF VERO_VUOSI > 2008 THEN DO;

		%VahennJakoS(PVALTTULOANSVERO, VERO_VUOSI, PVALTANSVAH, 1, PVALTTULOVERO, PKUNNVERO, PSVMAKSU, PKEVMAKSU, PKIRKVEROS, 0);
		%VahennJakoS(PKUNNALLISVERO, VERO_VUOSI, PVALTANSVAH, 2, PVALTTULOVERO, PKUNNVERO, PSVMAKSU, PKEVMAKSU, PKIRKVEROS, 0);
		%VahennJakoS(PSAIRAUSVAKUUTUSMAKSU, VERO_VUOSI, PVALTANSVAH, 3, PVALTTULOVERO, PKUNNVERO, PSVMAKSU, PKEVMAKSU, PKIRKVEROS, 0);
		%VahennJakoS(PKELAVAKUUTUSMAKSU, VERO_VUOSI, PVALTANSVAH, 4, PVALTTULOVERO, PKUNNVERO, PSVMAKSU, PKEVMAKSU, PKIRKVEROS, 0);
		%VahennJakoS(PKIRKOLLISVERO, VERO_VUOSI, PVALTANSVAH, 5, PVALTTULOVERO, PKUNNVERO, PSVMAKSU, PKEVMAKSU, PKIRKVEROS, 0);
	...
	* Valtion tulovero invalidi- ja ansiotulovähennyksen jälkeen;
	...
	PVALTTULOINV = MAX(PVALTTULOANSVERO2 - PINVVAH - PVELVVAHV, 0);
...
ELSE DO;
	...
	* Vähennykset vain valtionverotuksessa;
	...
	%ValtElTulVahS(PELVAHV, VERO_VUOSI, INF, VERO_PETULO, PPUHDASANSTULO, PKOKONTULO);

	%ValtTyoTuloVahS(PVALTTVAH, VERO_VUOSI, INF, PANSIOTULO, (VERO_PPTULO + VERO_PMERITULO));

	%ValtVerMeriVahS(PMERIVAHVAL, VERO_VUOSI, INF, VERO_PMERITULO); 

	* Vähennykset vain kunnallisverotuksessa;

	PMUAANS2 = MAX(PANSIOTULO - VERO_PETULO,0);

	%KunnAnsVahS(PKUNNANS, VERO_VUOSI, INF, PPUHDASANSTULO, PMUAANS2, (VERO_PPTULO + VERO_PMERITULO + VERO_PMTULO), (VERO_PPTULO + VERO_PMERITULO), PKOKONTULO);

	%KunnElTulVahS(PELVELVAHK, VERO_VUOSI, INF, VERO_PUOLISO, 0, VERO_PETULO, PPUHDASANSTULO, PKOKONTULO);

	%KunnVerMeriVahS(PMERIVAHKUN, VERO_VUOSI, INF, VERO_PMERITULO);

	%KunnOpRahVahS(POPRAHVAHK, VERO_VUOSI, INF, VERO_POPISK, VERO_POPRAHA, PANSIOTULO, PPUHDASANSTULO);
	...
	* Verotettava tulo kunnallisverotuksessa ennen perusvähennystä;
	...
	IF VERO_VUOSI < 1993 THEN PPA = PKOKONTULO + PYHTHYVPO - SUM(PTULHANKSUMS, PTULHANKSUMSM) - VERO_PPOVAHENN;
	ELSE PPA = PPUHDASANSTULO;

	%KunnVerInvVahS(PINVVAH_K, VERO_VUOSI, INF, VERO_PINVOIKEUS82, VERO_PINVPROS, PPA, VERO_PETULO);

	PKUNNVEROTULO = MAX(PPA - PTYOELMAKSU - PTYOTMAKSU - PSPMAKSU - PKUNNANS - PMERIVAHKUN - PELVELVAHK - POPRAHVAHK - VERO_PMUUVAHKUNN - PINVVAH_K,0);

	IF PKUNNVEROTULO < 0 THEN PKUNNVEROTULO = 0;

	%KunnPerVahS(PPERVAH, VERO_VUOSI, INF, PKUNNVEROTULO);
	...
	* Vähennyksiä veroista;
	...
	%ValtVerAnsVahS(PVALTANSVAH, VERO_VUOSI, INF,  (VERO_PPTULO + VERO_PMERITULO + VERO_PMTULO + VERO_POSANSTULO), PPUHDASANSTULO);
	...
	* Tuloverot ennen ansiotulovähennystä;
	...
	%ValtTuloVeroS(PVALTTULOVERO, VERO_VUOSI, INF, PVALTVEROTULO);
	...
	%SairVakMaksuS(PSVMAKSU, VERO_VUOSI, INF, PKUNNVERTULOSP, VERO_PETULO, (VERO_PPTULO + VERO_PMERITULO + VERO_PMTULO));
...
************************************************************************************************************************;
	...
	* Ansiotulojen verot (1993-) tai tuloverot yhteensä;
	...
	PANSTULVEROT = PVALTTULOANSVERO5 + PKUNNALLISVERO5 + PSAIRAUSVAKUUTUSMAKSU5 + PKELAVAKUUTUSMAKSU5 + PKIRKOLLISVERO5;
	...
	* Valtionvero kattosäännön jälkeen;
	...
	%ValtVero_FinalS(PVVKAT, VERO_VUOSI, PYHTVALTVEROTULO, PVALTTULOVERO, PPAAOMAVERO3, (PKUNNALLISVERO5 + PSAIRAUSVAKUUTUSMAKSU5 + PKELAVAKUUTUSMAKSU5 + PKIRKOLLISVERO5));
	...
	PKAIKKIVEROT1 = PKUNNALLISVERO5 + PSAIRAUSVAKUUTUSMAKSU5 + PKELAVAKUUTUSMAKSU5 + PKIRKOLLISVERO5 + (PVAVERO + PVALTTULVERKAT);

	IF PVALTTULOVERO < PVALTANSVAH THEN PTEMPD = PVALTANSVAH - PVALTTULOVERO;
	ELSE PTEMPD = 0;

	IF VERO_VUOSI < 2009 THEN PTEMPE = MIN(PTEMPD, PKUNNALLISVERO5 + PSAIRAUSVAKUUTUSMAKSU5 + PKELAVAKUUTUSMAKSU5 + PKIRKOLLISVERO5);
	ELSE PTEMPE = 0; 

	PKAIKKIVEROT2 = PKUNNALLISVERO5 + PSAIRAUSVAKUUTUSMAKSU5 + PKELAVAKUUTUSMAKSU5 + PKIRKOLLISVERO5 + (PVALTTULOANSVERO5 + PPAAOMAVERO3) - PYHTHYVYHT - PTEMPE;
	...
	%ValtTuloVeroS(PTEMPF, VERO_VUOSI, INF, PVALTVEROTULO);
	...
	%YhtHyvJakoS(PVALTIO1, 1, PYHTHYVANS, PYHTHYVPO, (PVALTTULOANSVERO3 + PPAAOMAVERO3), PVALTTULOANSVERO5, PKUNNALLISVERO5, PSVMAKSU, 0, PKIRKOLLISVERO5);
	PVALTIO = PVALTIO1 - PTEMPH;

	%YhtHyvJakoS(PKUNNAT, 2, PYHTHYVANS, PYHTHYVPO, (PVALTTULOANSVERO3 + PPAAOMAVERO3), PVALTTULOANSVERO5, PKUNNALLISVERO5, PSVMAKSU, 0, PKIRKOLLISVERO5);

	%YhtHyvJakoS(PKELA1, 3, PYHTHYVANS, PYHTHYVPO, (PVALTTULOANSVERO3 + PPAAOMAVERO3), PVALTTULOANSVERO5, PKUNNALLISVERO5, PSVMAKSU, 0, PKIRKOLLISVERO5);
	PKELA = PKELA1 + PSPMAKSU;

	%YhtHyvJakoS(PKIRKKO, 5, PYHTHYVANS, PYHTHYVPO, (PVALTTULOANSVERO3 + PPAAOMAVERO3), PVALTTULOANSVERO5, PKUNNALLISVERO5, PSVMAKSU, 0, PKIRKOLLISVERO5);
...
ANS = 'Ansiotulovähennys (2023-), (e)'
OPRAHVAH = 'Opintorahavähennys (2023-), (e)'
ELVAHV = 'Valtionverotuksen eläketulovähennys, (e)'
MERIVAHVAL = 'Valtionverotuksen merityötulovähennys, (e)'
VALTTVAH = 'Valtionverotuksen työtulovähennys ja palkkavähennys, (e)'
KUNNANS = 'Kunnallisverotuksen ansiotulovähennys, (e)'
ELVELVAHK = 'Kunnallisverotuksen eläketulovähennys, (e)'
MERIVAHKUN = 'Kunnallisverotuksen merityötulovähennys, (e)'
OPRAHVAHK = 'Kunnallisverotuksen opintorahavähennys, (e)'
...
KUNNVEROTULO = 'Verotettava tulo kunnallisverotuksessa ennen perusvähennystä, (e)'
PERVAH = 'Perusvähennys (2023-) / Kunnallisverotuksen perusvähennys (-2022), (e)'
KUNNVERTULOSP = 'Verotettava tulo kunnallisverotuksessa, (e)'
VALTANSVAH = 'Ansiotulovähennys valtionverosta, (e)'
INVVAH = 'Invalidivähennys valtionverosta (ja vanhuusvähennys), (e)' 
INVVAH_K = 'Invalidivähennys kunnallisverosta , (e)' 
...
VEROTULO = 'Verotettava tulo (2023-), (e)'
...
VALTTULOANSVERO = 'Ansiotulojen valtionvero ansio/työtulovähennyksen jälkeen, (e)'
KUNNALLISVERO = 'Kunnallisvero ansio/työtulovähennyksen jälkeen, (e)'
SAIRAUSVAKUUTUSMAKSU = 'Sairausvakuutusmaksu ansio/työtulovähennyksen jälkeen, (e)'
KELAVAKUUTUSMAKSU = 'Kansaneläkevakuutusmaksu ansio/työtulovähennyksen jälkeen, (e)'
KIRKOLLISVERO = 'Kirkollisvero ansio/työtulovähennyksen jälkeen, (e)'
...
PANS = 'Puoliso: Verotuksen ansiotulovähennys (2023-), (e)'
PELVAHV = 'Puoliso: Valtionverotuksen eläketulovähennys, (e)'
PMERIVAHVAL = 'Puoliso: Valtionverotuksen merityötulovähennys, (e)'
PVALTTVAH = 'Puoliso: Valtionverotuksen työtulovähennys ja palkkavähennys, (e)'
PKUNNANS = 'Puoliso: Kunnallisverotuksen ansiotulovähennys, (e)'
PELVELVAHK = 'Puoliso: Kunnallisverotuksen eläketulovähennys, (e)'
PMERIVAHKUN = 'Puoliso: Kunnallisverotuksen merityötulovähennys, (e)'
POPRAHVAHK = 'Puoliso: Kunnallisverotuksen opintorahavähennys, (e)'
...
PKUNNVEROTULO = 'Puoliso: Verotettava tulo kunnallisverotuksessa ennen perusvähennystä, (e)'
PPERVAH = 'Puoliso: Perusvähennys (2023-) / Kunnallisverotuksen perusvähennys (-2022), (e)'
PKUNNVERTULOSP = 'Puoliso: Verotettava tulo kunnallisverotuksessa, (e)'
PVALTANSVAH = 'Puoliso: Ansiotulovähennys valtionverosta, (e)'
PINVVAH = 'Puoliso: Invalidivähennys valtionverosta (ja vanhuusvähennys), (e)' 
PINVVAH_K = 'Puoliso: Invalidivähennys kunnallisverosta , (e)'
...
PVEROTULO = 'Puoliso: Verotettava tulo (2023-), (e)'
...
PVALTTULOANSVERO = 'Puoliso: Ansiotulojen valtionvero ansio/työtulovähennyksen jälkeen, (e)'
PKUNNALLISVERO = 'Puoliso: Kunnallisvero ansio/työtulovähennyksen jälkeen, (e)'
PSAIRAUSVAKUUTUSMAKSU = 'Puoliso: Sairausvakuutusmaksu ansio/työtulovähennyksen jälkeen, (e)'
PKELAVAKUUTUSMAKSU = 'Puoliso: Kansaneläkevakuutusmaksu ansio/työtulovähennyksen jälkeen, (e)'
PKIRKOLLISVERO = 'Puoliso: Kirkollisvero ansio/työtulovähennyksen jälkeen, (e)'
