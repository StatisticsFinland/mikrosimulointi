...
%LET MINIMI_TOIMTUKI_VUOSI = 2026;
%LET MAKSIMI_TOIMTUKI_VUOSI = 2026;
...
* Ik‰;
%LET MINIMI_TOIMTUKI_IKA = 45;
%LET MAKSIMI_TOIMTUKI_IKA = 45;
%LET KYNNYS_TOIMTUKI_IKA = 5;
...
DO TOIMTUKI_IKA = &MINIMI_TOIMTUKI_IKA TO &MAKSIMI_TOIMTUKI_IKA BY &KYNNYS_TOIMTUKI_IKA;
...
IF &VUOSIKA = 1 THEN DO;
	...
	%ToimTukiVS(TOIMTUKIKK, TOIMTUKI_VUOSI, INF, TOIMTUKI_KRYHMA, 1, 
			...
			TOIMTUKI_LAPSILISAT, TOIMTUKI_TYOTULO_ARR, TOIMTUKI_MUUTTULOT, TOIMTUKI_ASMENOT, TOIMTUKI_HARKMENOT, TOIMTUKI_TULONHANK_ARR, TOIMTUKI_IKA_ARR);
...
DROP TOIMTUKI_TYOTULO_ARR1 TOIMTUKI_TULONHANK_ARR1 TOIMTUKI_IKA_ARR1 i;
...
TOIMTUKI_LAPSIA10_16 TOIMTUKI_LAPSIAALLE10 TOIMTUKI_TUKIAIKA TOIMTUKI_EPIDEMKORVAIKA EPIDEMKORVAIKAKORJ TOIMTUKI_IKA 8.;
