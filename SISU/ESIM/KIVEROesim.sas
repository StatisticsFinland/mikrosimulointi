...
* Vapaa-ajan asunnon kuistin pinta-ala m2;
%LET MINIMI_KIVERO_KUISTIPA = 10; 
%LET MAKSIMI_KIVERO_KUISTIPA = 10;
%LET KYNNYS_KIVERO_KUISTIPA = 5;	
...
DO KIVERO_KUISTIPA = &MINIMI_KIVERO_KUISTIPA TO &MAKSIMI_KIVERO_KUISTIPA BY &KYNNYS_KIVERO_KUISTIPA;
...
KIVERO_VESIK, KIVERO_LAMMITYSK, KIVERO_SAHKOK, 1, 100);
...
KIVERO_VESIK, KIVERO_LAMMITYSK, KIVERO_SAHKOK, 1, KIVERO_VEROPROS, 100);
...
KIVERO_TALVIASK, KIVERO_KUISTIPA, KIVERO_SAHKOK, KIVERO_VIEMARIK, KIVERO_VESIK, KIVERO_WCK, KIVERO_SAUNAK, 1, 100);
...
KIVERO_TALVIASK, KIVERO_KUISTIPA, KIVERO_SAHKOK, KIVERO_VIEMARIK, KIVERO_VESIK, KIVERO_WCK, KIVERO_SAUNAK, 1, KIVERO_VEROPROS, 100);
