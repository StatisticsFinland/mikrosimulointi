...
Yleisen asumistuen määräytymiseen liittyvät tiedot:
	...
	2 = Hyvinkää, Hämeenlinna, Joensuu, Jyväskylä, Järvenpää, 
	Kerava, Kirkkonummi, Kuopio, Lahti, Lohja, Nokia, Nurmijärvi, 
	Oulu, Porvoo, Raisio, Riihimäki, Rovaniemi, Seinäjoki, Sipoo, 
	Siuntio, Tampere, Turku, Tuusula ja Vihti
	3 = Muut kunnat

	Seuraava ryhmittely on voimassa vuonna 2024:
	1 = Helsinki, Espoo, Kauniainen ja Vantaa
	2 = Hyvinkää, Hämeenlinna, Joensuu, Jyväskylä, Järvenpää,
	...
	Seuraava ryhmittely oli voimassa vuosina 2015-2023:
	1 = Helsinki
	...
	Ryhmittely voimassa vuoteen 2014 asti.
...
Eläkkeensaajan asumistuen määräytymiseen liittyvät tiedot:
	...
	Ryhmittely voimassa vuoteen 2007 asti.
...
312 Korotettu vanhempainraha (ei käytössä 2015-7/2022)
(32 Osapäiväraha)
...
TTPAIVAT: Henkilölle aiemmin maksettujen työttömyyspäivärahapäivien lukumäärä (kertymä)
*/
...
%LET MINIMI_KOKO_TTPAIVAT = 0;
%LET MAKSIMI_KOKO_TTPAIVAT = 0; 
%LET KYNNYS_KOKO_TTPAIVAT = 10;

/* 2.5.4 Lisäoletuksia toimeentulotukea varten */

/* Onko henkilö oikeutettu toimeentulotukeen (1 = Kyllä, 0 = Ei) */
%LET MINIMI_KOKO_TOIMTUKI_OIKEUS = 1;
...
/* 2.8 Huomioitavan varallisuuden määrä yleisessä asumistuessa tai eläkkeensaajan asumistuessa */

%LET MINIMI_KOKO_VARAT_ASUMTUKI = 0;
%LET MAKSIMI_KOKO_VARAT_ASUMTUKI = 0;
%LET KYNNYS_KOKO_VARAT_ASUMTUKI = 10000;
...
DO KOKO_KUUK = &MINIMI_KOKO_KUUK TO &MAKSIMI_KOKO_KUUK;
 ...
 KOKO_TOIMTUKI_OIKEUS = &MINIMI_KOKO_TOIMTUKI_OIKEUS;
...
DO KOKO_TTPAIVAT = &MINIMI_KOKO_TTPAIVAT TO &MAKSIMI_KOKO_TTPAIVAT BY &KYNNYS_KOKO_TTPAIVAT;
DO KOKO_VARAT_ASUMTUKI = &MINIMI_KOKO_VARAT_ASUMTUKI TO &MAKSIMI_KOKO_VARAT_ASUMTUKI BY &KYNNYS_KOKO_VARAT_ASUMTUKI;
...
IF SUBSTRN(KOKO_TILANNE&suff, 1, 1) = 2 THEN DO;
	...
	IF KOKO_TILANNE&suff = 2 THEN DO;
		...
		%IF &VUOSIKA = 2 %THEN %DO;
			...
			IF (KOKO_KOROTUS OR KOKO_MTURVA) AND KOKO_VUOSI >= 2013 THEN DO;
				%AnsioSidKS (TYOTPRIK&suff, KOKO_VUOSI, KOKO_KUUK, INF, YHTLAPSIATTURVA&suff, 0, 0, 0, KOKO_EDPALKKA&suff, 0, KOKO_TTPAIVAT, 0, aktiivi=KOKO_AKTIIVI);
				TYOTKOROSA&suff=SUM(TYOTPR&suff,-TYOTPRIK&suff);
			END;
		%END;
		%ELSE %DO;
			%AnsioSidVS (TYOTPR&suff, KOKO_VUOSI, INF, YHTLAPSIATTURVA&suff, KOKO_KOROTUS, KOKO_MTURVA, 0, KOKO_EDPALKKA&suff, 0, KOKO_TTPAIVAT, 0, aktiivi=KOKO_AKTIIVI);
			IF (KOKO_KOROTUS OR KOKO_MTURVA) AND KOKO_VUOSI >= 2013 THEN DO;
				%AnsioSidVS (TYOTPRIK&suff, KOKO_VUOSI, INF, YHTLAPSIATTURVA&suff, 0, 0, 0, KOKO_EDPALKKA&suff, 0, KOKO_TTPAIVAT, 0, aktiivi=KOKO_AKTIIVI);
				TYOTKOROSA&suff=SUM(TYOTPR&suff,-TYOTPRIK&suff);
			END;
		%END;
	END;
	...
	ELSE IF KOKO_TILANNE&suff = 22 THEN DO; 
    	...
    	%IF &VUOSIKA = 2 %THEN %DO; 
			...
			%END;
			%ELSE %DO;
				%TyomTukiKS (TYOTPR&suff, KOKO_VUOSI, KOKO_KUUK, INF, 1, 0, KOKO_PUOLISO, YHTLAPSIATTURVA&suff, 0, 0, SUM(KOKO_PALKKA, TYOTPR), 0, 0, (KOKO_KOROTUS OR KOKO_MTURVA), 0, aktiivi=KOKO_AKTIIVI); 
            %END; 
		%END;
        %ELSE %DO; 
			%IF (&onkopuoliso = 0) %THEN %DO;
	...
	IF KOKO_PALKKA&suff > 0 THEN DO;
		...
		%END;
		%ELSE %DO;
			%SoviteltuVS (TYOTPR&suff, KOKO_VUOSI, INF, IFN(KOKO_TILANNE&suff = 2, 1, 0), (KOKO_KOROTUS OR KOKO_MTURVA), YHTLAPSIATTURVA&suff, TYOTPR&suff, KOKO_PALKKA&suff, KOKO_EDPALKKA&suff, 0, aktiivi=KOKO_AKTIIVI);
		%END;
	END;
...
IF SUBSTRN(KOKO_TILANNE&suff, 1, 1) = 3 THEN DO;
	...
	/* 4.2.3 Raskauspäiväraha 40 päivältä 08/2022 alkaen; äitiysraha 56 ensimmäiseltä päivältä (07/2022 asti); 90 %:n kerroin */
	...
	/* 4.2.4 Korotettu vanhempainraha; 75 %:n kerroin 2015 asti. 90 % kerroin 08/2022 alkaen */
...
IF SUBSTRN(KOKO_TILANNE&suff, 1, 1) = 5 AND KOKO_OMISTUS = 0 AND 
	...
	%IF &VUOSIKA = 2 %THEN %DO;
		%AsumLisaKS (ASLIS&suff, KOKO_VUOSI, KOKO_KUUK, INF, (KOKO_TILANNE&suff NE 52), KOKO_IKA&suff, 0, VUOKRA, KOKO_PALKKA&suff, 0, 0, 0, KOKO_YAKRYHMA);
	%END;
	%ELSE %DO;
		%AsumLisaVS (ASLIS&suff, KOKO_VUOSI, INF, (KOKO_TILANNE&suff NE 52), KOKO_IKA&suff, 0, VUOKRA, KOKO_PALKKA&suff, 0, 0, 0, KOKO_YAKRYHMA);
	%END;
...
IF KOKO_TILANNE&suff = 6 THEN DO;
	...
	%IF &VUOSIKA = 2 %THEN %DO;
		%Kansanelake_SimpleKS (KANSEL&suff, KOKO_VUOSI, KOKO_KUUK, INF, 0, KOKO_PUOLISO, KOKO_KELRYHMA, 12*KOKO_ELAKE&suff, 1, KOKO_IKA);
		%TakuuElakeKS (TAKUUEL&suff, KOKO_VUOSI, KOKO_KUUK, INF, SUM(KOKO_ELAKE&suff, KANSEL&suff), 1, KOKO_IKA);
	%END;
	%ELSE %DO;
		%Kansanelake_SimpleVS (KANSEL&suff, KOKO_VUOSI, INF, 0, KOKO_PUOLISO, KOKO_KELRYHMA, 12*KOKO_ELAKE&suff, 1, KOKO_IKA);
		%TakuuElakeVS (TAKUUEL&suff, KOKO_VUOSI, INF, SUM(KOKO_ELAKE&suff, KANSEL&suff), 1, KOKO_IKA);
...
/* Eläkevakuutusmaksu ja muut palkasta perittävät maksut */
...
IF KOKO_PALKKA&suff > 0 THEN DO;
	%TulonHankKulutS(HANKVAH&suff, KOKO_VUOSI, INF, 12*KOKO_PALKKA&suff, 12*KOKO_TULONHANKKULUT&suff, 12*KOKO_AYMAKSUT&suff, 12*KOKO_TYOMATKAKULUT&suff, 0);
END;
ELSE DO;
	HANKVAH&suff = 0;
END;
...
PUHDANSIOTULO&suff = MAX(SUM(ANSIOTULO&suff, -HANKVAH&suff), 0);

/* Ansiotulovähennys (2023-2024) */
%AnsVahS (ANS&suff, KOKO_VUOSI, INF,  PUHDANSIOTULO&suff, 12*KOKO_PALKKA&suff);

/* Kunnallisverotuksen ansiotulovähennys (-2022) */
...
IF KOKO_VUOSI >= 2023 THEN DO; 
	...
	VERTULO2&suff = MAX(SUM(VERTULO1&suff, -PER&suff), 0);
	KUNNVERTULO2&suff = VERTULO2&suff;
END;
ELSE DO;
	/* Verotettava tulo kunnallisverotuksessa ennen ja jälkeen perusvähennyksen (-2022) */
	KUNNVERTULO1&suff = MAX(SUM(ANSIOTULO&suff, -PALKVAK&suff, -HANKVAH&suff, -KUNNANS&suff, -KUNNOPRAHVAH&suff, -KUNNELVAH&suff), 0);
	%KunnPerVahS (KUNNPER&suff, KOKO_VUOSI, INF, KUNNVERTULO1&suff);
	KUNNVERTULO2&suff = MAX(SUM(KUNNVERTULO1&suff, -KUNNPER&suff), 0);
END;
...
/* Sairaanhoitomaksu/sairausvakuutusmaksu */
...
IF KOKO_VUOSI >= 2023 THEN DO;
	VALTVERTULO&suff = VERTULO2&suff;
END;
ELSE DO;
	VALTVERTULO&suff = MAX(SUM(ANSIOTULO&suff, -PALKVAK&suff, -HANKVAH&suff, -VALTELVAH&suff), 0);
END;

/* Valtionvero ennen verosta tehtäviä vähennyksiä */
%ValtTuloVeroS (VALTVERO&suff, KOKO_VUOSI, INF, VALTVERTULO&suff, 0);
...
/* Työtulovähennys ja sen jako eri verolajeihin */
%TyotVahS(TYOTULVAH&suff, KOKO_VUOSI, INF, 12*KOKO_PALKKA&suff, PUHDANSIOTULO&suff, KOKO_IKA&suff, -(KOKO_PUOLISO-1), SUM(KOKO_LAPSIA_ALLE3, KOKO_LAPSIA_3_6, KOKO_LAPSIA_7_9, KOKO_LAPSIA_10_15, KOKO_LAPSIA_16))

IF KOKO_VUOSI > 2008 THEN DO;
	%VahennJakoS(VALTVERO_B&suff, KOKO_VUOSI, TYOTULVAH&suff, 1, VALTVERO&suff, KUNNVERO&suff, SAIRVAKM&suff, KANSELM&suff, KIRKVERO&suff, 0);
	%VahennJakoS(KUNNVERO_B&suff, KOKO_VUOSI, TYOTULVAH&suff, 2, VALTVERO&suff, KUNNVERO&suff, SAIRVAKM&suff, KANSELM&suff, KIRKVERO&suff, 0);
	%VahennJakoS(SAIRVAKM_B&suff, KOKO_VUOSI, TYOTULVAH&suff, 3, VALTVERO&suff, KUNNVERO&suff, SAIRVAKM&suff, KANSELM&suff, KIRKVERO&suff, 0);
	%VahennJakoS(KANSELM_B&suff, KOKO_VUOSI, TYOTULVAH&suff, 4, VALTVERO&suff, KUNNVERO&suff, SAIRVAKM&suff, KANSELM&suff, KIRKVERO&suff, 0);
	%VahennJakoS(KIRKVERO_B&suff, KOKO_VUOSI, TYOTULVAH&suff, 5, VALTVERO&suff, KUNNVERO&suff, SAIRVAKM&suff, KANSELM&suff, KIRKVERO&suff, 0);
END;
ELSE DO; 
	VALTVERO_B&suff = MAX(SUM(VALTVERO&suff, -TYOTULVAH&suff), 0);
...
/* Lapsivähennys ja sen jako eri verolajeihin */
...
/* Yleisradiovero */
%YleVeroS (YLEVERO&suff, KOKO_VUOSI, INF, KOKO_IKA&suff, PUHDANSIOTULO&suff, 0);

/* Nettokuukausitulo verojen jälkeen */
	...
	IF KOKO_VUOSI < 2015 OR (KOKO_VUOSI >= 2015 AND KOKO_LAPSIAYHT = 0) THEN DO;
		...
		%IF &VUOSIKA = 1 %THEN %DO;
			%ElakAsumTukiVS (ELASUMTUKI, KOKO_VUOSI, INF, KOKO_PUOLISO, KOKO_PUOLISO, 0, 0, KOKO_LAPSIAYHT, KOKO_OMAKOTI, 
				KOKO_EALAMMRYHMA, 1, 1, 0, 0, KOKO_PINTALA, KOKO_VALMVUOSI, KOKO_EAKRYHMA, SUM(ANSIOTULO, ANSIOTULO_PUOL), KOKO_VARAT_ASUMTUKI, 12*KOKO_VUOKRA_VASTIKE, 12*KOKO_ASKOROT);
		%END;
...
IF (KOKO_LAPSIAYHT > 0 OR ((KOKO_VUOSI > 2017 AND KOKO_VUOSI < 2025)
	%IF &VUOSIKA = 2 %THEN %DO;
	OR ((KOKO_VUOSI = 2017 AND KOKO_KUUK >= 8) OR (KOKO_VUOSI = 2025 AND KOKO_KUUK < 8))
	%END;
	...
	IF KOKO_OMISTUS = 0 THEN DO;
		...
		ELSE DO;
			%IF &VUOSIKA = 2 %THEN %DO;
				...
				ASTYOTULOT, IFN(KOKO_PUOLISO, 2, 1), KOKO_LAPSIAYHT, KOKO_VARAT_ASUMTUKI, opinraha = OPINRAHA_YA_HUOM);
			%END;
			%ELSE %DO;
...
DATA OUTPUT.&TULOSNIMI_KOKO;
	...
	KOKO_VUOKRA_VASTIKE KOKO_VESI KOKO_ASKOROT KOKO_TILANNE KOKO_TILANNE_PUOL KOKO_KOROTUS KOKO_MTURVA KOKO_AKTIIVI KOKO_TTPAIVAT KOKO_VARAT_ASUMTUKI KOKO_TOIMTUKI_OIKEUS KOKO_EPIDEMKORVL KOKO_PALKKA KOKO_TULONHANKKULUT KOKO_AYMAKSUT  
	...
	TYOEL TYOTMAKSU SVPRMAKSU PALKVAK HANKVAH ANSIOTULO PUHDANSIOTULO ANS ELVAH VERTULO1 PER VERTULO2 KUNNANS OPRAHVAH KUNNOPRAHVAH KUNNELVAH KUNNVERTULO1 KUNNPER KUNNVERTULO2 KUNNVERO KIRKVERO SAIRVAKM KANSELM
	VALTELVAH VALTVERTULO VALTVERO TYOTULVAH VALTVERO_B KUNNVERO_B SAIRVAKM_B KANSELM_B KIRKVERO_B VALTLAPS VALTVERO_C KUNNVERO_C SAIRVAKM_C KANSELM_C KIRKVERO_C
	...
	ANSIOTULO_PUOL PUHDANSIOTULO_PUOL ANS_PUOL ELVAH_PUOL VERTULO1_PUOL PER_PUOL VERTULO2_PUOL KUNNANS_PUOL OPRAHVAH_PUOL KUNNOPRAHVAH_PUOL KUNNELVAH_PUOL KUNNVERTULO1_PUOL KUNNPER_PUOL KUNNVERTULO2_PUOL KUNNVERO_PUOL KIRKVERO_PUOL
	SAIRVAKM_PUOL KANSELM_PUOL VALTELVAH_PUOL VALTVERTULO_PUOL VALTVERO_PUOL TYOTULVAH_PUOL VALTVERO_B_PUOL KUNNVERO_B_PUOL SAIRVAKM_B_PUOL KANSELM_B_PUOL
...
PROC DATASETS LIB=OUTPUT NOPRINT;
	...
	KOKO_TTPAIVAT = 'Henkilölle aiemmin maksettujen työttömyyspäivärahapäivien lukumäärä (kertymä)'
	KOKO_VARAT_ASUMTUKI = 'Yleisessä asumistuessa tai eläkkeensaajan asumistuessa huomioitava varallisuus'
	KOKO_TOIMTUKI_OIKEUS = 'Onko oikeutettu toimeentulotukeen, (0/1)'
	...
	ANS = 'Ansiotulovähennys (2023-2024), (e/v)'
	ANS_PUOL = 'Puoliso: Ansiotulovähennys (2023-2024), (e/v)'
	KUNNANS = 'Kunnallisverotuksen ansiotulovähennys (-2022), (e/v)'
	KUNNANS_PUOL = 'Puoliso: Kunnallisverotuksen ansiotulovähennys (-2022), (e/v)'
	OPRAHVAH = 'Opintorahavähennys, (e/v), (2023-)'
	OPRAHVAH_PUOL = 'Puoliso: Opintorahavähennys, (e/v), (2023-)'
	KUNNOPRAHVAH = 'Kunnallisverotuksen opintorahavähennys (e/v), (-2022)'
	KUNNOPRAHVAH_PUOL = 'Puoliso: Kunnallisverotuksen opintorahavähennys (e/v), (-2022)'
	ELVAH = 'Eläketulovähennys (2023-), (e/v)'
	ELVAH_PUOL = 'Puoliso: Eläketulovähennys (2023-), (e/v)'
	KUNNELVAH = 'Kunnallisverotuksen eläketulovähennys (-2022), (e/v)'
	KUNNELVAH_PUOL = 'Puoliso: Kunnallisverotuksen eläketulovähennys (-2022), (e/v)'
	VERTULO1 = 'Verotettava tulo ennen perusvähennystä (2023-), (e/v)'
	VERTULO1_PUOL = 'Puoliso: Verotettava tulo ennen perusvähennystä (2023-), (e/v)'
	KUNNVERTULO1 = 'Kunnalliverotuksessa verotettava tulo ennen perusvähennystä (-2022), (e/v)'
	KUNNVERTULO1_PUOL = 'Puoliso: Kunnalliverotuksessa verotettava tulo ennen perusvähennystä (-2022), (e/v)'
	PER = 'Perusvähennys (2023-), (e/v)'
	PER_PUOL = 'Puoliso: Perusvähennys (2023-), (e/v)'
	KUNNPER = 'Kunnallisverotuksen perusvähennys (-2022), (e/v)'
	KUNNPER_PUOL = 'Puoliso: Kunnallisverotuksen perusvähennys (-2022), (e/v)'
	...
	KUNNVERO_B = 'Kunnallisvero työtulovähennyksen jälkeen, (e/v)'
	KUNNVERO_B_PUOL = 'Puoliso: Kunnallisvero työtulovähennyksen jälkeen, (e/v)' 
	...
	KIRKVERO_B = 'Kirkollisvero työtulovähennyksen jälkeen, (e/v)'
	KIRKVERO_B_PUOL = 'Puoliso: Kirkollisvero työtulovähennyksen jälkeen, (e/v)'
	...
	SAIRVAKM_B_PUOL = 'Puoliso: Sairaanhoitomaksu/sairausvakuutusmaksu työtulovähennyksen jälkeen, (e/v)'
	...
	KANSELM_B = 'Kansaneläkevakuutusmaksu työtulovähennyksen jälkeen, (e/v)'
	...
	VALTELVAH = 'Valtionverotuksen eläketulovähennys (-2022), (e/v)'
	VALTELVAH_PUOL = 'Puoliso: Valtionverotuksen eläketulovähennys (-2022), (e/v)'
	...
	VALTVERO_B = 'Valtion tulovero työtulovähennyksen jälkeen, (e/v)'
	VALTVERO_B_PUOL = 'Puoliso: Valtion tulovero työtulovähennyksen jälkeen, (e/v)'
	...
	TYOTULVAH = 'Työtulovähennys, (e/v)'
	TYOTULVAH_PUOL = 'Puoliso: Työtulovähennys, (e/v)'
	...
	KOKO_TILANNE_PUOL KOKO_KOROTUS KOKO_MTURVA KOKO_AKTIIVI KOKO_EPIDEMKORVL KOKO_LAPSIAYHT OIKELASUM OPINTUKI_TUKIAIKA OPINTUKI_TUKIAIKA_PUOL KOKO_TTPAIVAT 8.;
