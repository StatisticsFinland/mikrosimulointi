...
%LET MINIMI_TTURVA_VUOSI = 2021;
%LET MAKSIMI_TTURVA_VUOSI = 2021;
...
IF TTURVA_TOIMINTA = 1 THEN DO;
	...
	IF TTURVA_TYOSSAOLO = 0 THEN DO;
		...
		IF &VUOSIKA = 2 THEN DO;
			%TyomTukiKS(TMTUKIK, TTURVA_VUOSI, TTURVA_KUUK, INF, (TTURVA_OMATULO > 0 OR TTURVA_PUOLTULO > 0), TTURVA_OSITT, TTURVA_PUOLISO, TTURVA_LAPSIA, TTURVA_HUOLL, TTURVA_OMATULO, TTURVA_PUOLTULO, TTURVA_VANHTULO, (TTURVA_OIKEUSKOR = 1), TTURVA_VAHSOSET, aktiivi=TTURVA_AKTIIVI);
		END;
		ELSE DO;
			%TyomTukiVS(TMTUKIK, TTURVA_VUOSI, INF, (TTURVA_OMATULO > 0 OR TTURVA_PUOLTULO > 0), TTURVA_OSITT, TTURVA_PUOLISO, TTURVA_LAPSIA, TTURVA_HUOLL, TTURVA_OMATULO, TTURVA_PUOLTULO, TTURVA_VANHTULO, (TTURVA_OIKEUSKOR = 1), TTURVA_VAHSOSET, aktiivi=TTURVA_AKTIIVI);
		END;
...
/* 3.2.3 Ansiosidonnainen päiväraha */
	...
	ELSE IF TTURVA_TYOSSAOLO = 1 AND TTURVA_TYOTKASS = 1 THEN DO; 
		...
		IF &VUOSIKA = 2 THEN DO;
			%AnsioSidKS(ANSIOSIDK, TTURVA_VUOSI, TTURVA_KUUK, INF, TTURVA_LAPSIA, (TTURVA_OIKEUSKOR = 1), (TTURVA_OIKEUSKOR = 2), (TTURVA_OIKEUSKOR = 3), TTURVA_KUUKPALK, TTURVA_VAHSOSET, aktiivi=TTURVA_AKTIIVI);
		END;
		ELSE DO;
			%AnsioSidVS(ANSIOSIDK, TTURVA_VUOSI, INF, TTURVA_LAPSIA, (TTURVA_OIKEUSKOR = 1), (TTURVA_OIKEUSKOR = 2), (TTURVA_OIKEUSKOR = 3), TTURVA_KUUKPALK, TTURVA_VAHSOSET, aktiivi=TTURVA_AKTIIVI);
		END;
		IF TTURVA_SOVTULO > 0 THEN DO;
...
TTURVA_KOULTUKI TTURVA_PUOLISO TTURVA_OSITT TTURVA_HUOLL TTURVA_AKTIIVI 8.;
