...
%LET MINIMI_KANSEL_VUOSI = 2026;
%LET MAKSIMI_KANSEL_VUOSI = 2026;
...
IF &VUOSIKA = 2 THEN DO;
	%Kansanelake_SimpleKS(KANSELK, KANSEL_VUOSI, KANSEL_KUUK, INF, KANSEL_LAITOS, KANSEL_PUOLISO, KANSEL_KUNRY, SUM(KANSEL_MUUELTULO, KANSEL_MUUPELTULO), 1, KANSEL_IKA,
	ontyokyvyte = IFN(KANSEL_TOIMINTA = 1, 1, 0), tyotulo = KANSEL_TYOTULO / 12);
END;
ELSE DO;
	%Kansanelake_SimpleVS(KANSELK, KANSEL_VUOSI, INF, KANSEL_LAITOS, KANSEL_PUOLISO, KANSEL_KUNRY, SUM(KANSEL_MUUELTULO, KANSEL_MUUPELTULO), 1, KANSEL_IKA,
	ontyokyvyte = IFN(KANSEL_TOIMINTA = 1, 1, 0), tyotulo = KANSEL_TYOTULO / 12);
END;
...
IF &VUOSIKA = 2 THEN DO;
	%TakuuElakeKS(TAKUUELK, KANSEL_VUOSI, KANSEL_KUUK, INF, SUM(KANSEL_MUUELTULO/12, KANSEL_MUUPELTULO/12, KANSELK), 1, KANSEL_IKA,
	ontyokyvyte = IFN(KANSEL_TOIMINTA = 1, 1, 0), tyotulo = KANSEL_TYOTULO / 12);
END;
ELSE DO;
	%TakuuElakeVS(TAKUUELK, KANSEL_VUOSI, INF, SUM(KANSEL_MUUELTULO/12, KANSEL_MUUPELTULO/12, KANSELK), 1, KANSEL_IKA,
	ontyokyvyte = IFN(KANSEL_TOIMINTA = 1, 1, 0), tyotulo = KANSEL_TYOTULO / 12);
END;
...
IF &VUOSIKA = 2 THEN DO;
	...
	IF KANSEL_RINTAMA NE 0 THEN DO;
		...
		IF KANSEL_VUOSI < 1997 THEN DO;
			%Kansanelake_SimpleKS(LISAOSA, KANSEL_VUOSI, KANSEL_KUUK, INF, KANSEL_LAITOS, KANSEL_PUOLISO, KANSEL_KUNRY, 0, 1, KANSEL_IKA);
...
ELSE DO;
	...
	IF KANSEL_RINTAMA NE 0 THEN DO;
		...
		IF KANSEL_VUOSI < 1997 THEN DO;
			%Kansanelake_SimpleVS(LISAOSA, KANSEL_VUOSI, INF, KANSEL_LAITOS, KANSEL_PUOLISO, KANSEL_KUNRY, 0, 1, KANSEL_IKA);
			LISAOSA = LISAOSA - &PerPohja;
		END;
...
IF &VUOSIKA = 2 THEN DO;
	%SotilasAvKS(SOTILAVK, KANSEL_VUOSI, KANSEL_KUUK, INF, KANSEL_KUNRY, SUM(KANSEL_PUOLISO, KANSEL_18VLAPSIA), KANSEL_ASUMMENOT, KANSEL_OMATULO, KANSEL_PUOLTULO);
END;
ELSE DO;
	%SotilasAvVS(SOTILAVK, KANSEL_VUOSI, INF, KANSEL_KUNRY, SUM(KANSEL_PUOLISO, KANSEL_18VLAPSIA), KANSEL_ASUMMENOT, KANSEL_OMATULO, KANSEL_PUOLTULO);
END;
