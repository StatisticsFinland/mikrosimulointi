...
'14' = 'Kotitaloudet'
'15' = 'Kotitalouksia palvelevat voittoa tavoittelemattomat yhteisˆt'
'2' = 'Ulkomaat'
'' = '';
...
VALUE $siviilisaaty (NOTSORTED MULTILABEL)
'1' = 'Naimaton'
...
VALUE $odta (NOTSORTED MULTILABEL)
'1' = 'Syksy'
'2' = 'Kev‰t'
'3' = 'Kev‰t ja syksy';
...
4 = 'Osittainen varhennettu vanhuusel‰ke (ennen vuotta 2017 tyˆttˆmyysel‰ke)'
5 = 'Maatalouden erityisel‰kkeet'
6 = 'Osa-aikael‰ke'
7 = 'Varhennettu vanhuusel‰ke'
8 = 'Tyˆurael‰ke (ennen vuotta 2018 yksilˆllinen varhaisel‰ke)'
...
/* TOIMIALA  (toimialaluokitus 2008 yl‰taso) */
