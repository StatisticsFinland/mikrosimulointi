/***********************************************************
* Kuvaus: Lapsilisän simulointimalli	            	   *
***********************************************************/ 
...
%IF &START NE 1 %THEN %DO;
	...
	* Tulostaulukoiden esivalinnat ; 
	...
	%LET MUUTTUJAT = bbyhte LLISA_HH lbeltuki ELATUSTUET_HH aitav AITAVUST ; * Taulukoitavat muuttujat (summataulukot) ;
...
%IF &POIMINTA = 1 %THEN %DO;
	...
	* Määritellään tarvittavat muuttujat taulukkoihin START_LLISA, START_AITAV, START_ELTUKI;
	...
	DATA STARTDAT.START_LLISA; 
  	...
  	(KEEP = hnro knro asko bbyhte elivtu ikavu ikakk);
...
%IF &START NE 1 %THEN %DO;
	...
	%IF &TULOSLAAJ = 1 %THEN %DO; 
		...
		(KEEP = hnro knro &PAINO bbyhte lbeltuki aitav ikavu ikavuv desmod soss paasoss elivtu koulas koulasv rake maakunta)
		TEMP.&TULOSNIMI_LL;
	%END;
