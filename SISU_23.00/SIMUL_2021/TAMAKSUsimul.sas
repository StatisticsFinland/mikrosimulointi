/*********************************************************** *
 *  Kuvaus: Tyˆnantajamaksujen simulointimalli			     * 
 * **********************************************************/
...
%MACRO Aloitus;
	...
	%LET LVUOSI = 2021;		* Lains‰‰d‰ntˆvuosi (vvvv);

	%LET AINEISTO = r20_tamaksu; 	* K‰ytett‰v‰ aineisto;
...
(KEEP = hnro ykor palkka ikavu tsekt pros muulis autovere JARJESTYS);
